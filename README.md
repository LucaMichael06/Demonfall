...
cred:AddButton({text = "how much sun ore you have?", callback = function()
    setclipboard("how much sun ore you have?")
end})
cred:AddButton({text = "Discord", callback = function()
    setclipboard("discord.gg/8Cj5abGrNv")
end})

cred:AddLabel({text = "GodMode|how much sun ore you have?"})
